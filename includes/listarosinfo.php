...
if($retorno->id_status != '1'){
  $saida .= '
    ...
    <span><b>Observações Solicitante</b></span>
  ...
  $saida .= '
    ...
    <input type="hidden" name="observacoesantigassetor" value="'.$retorno->observacoessetor.'">
    <input type="hidden" name="acao" value="atualizarHistoricoUsuario">
